...
namespace GeniusBooks {
	...
	{
	private:
		String^ connectionString = R"(Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\.data\MicrosoftSQLServerDatabases\DB_GeniusBooks.mdf;Integrated Security=True;Connect Timeout=30)";
