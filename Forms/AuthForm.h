...
namespace GeniusBooks {
	...
	public ref class AuthForm : public System::Windows::Forms::Form
	{
		...
		private: void setPanel() {
			if (currentPanel == 1) {
				...
				login_panel->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &AuthForm::closeForm);
				...
				register_panel->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &AuthForm::closeForm);
	...
	#pragma endregion
		...
		private: System::Void labelLink_LinkClicked(System::Object^ sender, System::Windows::Forms::LinkLabelLinkClickedEventArgs^ e
		) {
			currentPanel = currentPanel == 1 ? 2 : 1;
			setPanel();
		}
		private: void closeForm(System::Object^ sender, System::Windows::Forms::FormClosedEventArgs^ e) {
			AdminForm^ adminForm = gcnew AdminForm();
			adminForm->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &AuthForm::exitApplication);
			adminForm->Show();
			this->Hide();
		}
		private: void exitApplication(System::Object^ sender, System::Windows::Forms::FormClosedEventArgs^ e) {
			Application::Exit();
		}
	};
}
